...
1. 同一主题可以同时存在 nopic 与 maxi 两套 ZIM。
2. nopic 用于 AI 检索和决策支持。
3. maxi 用于人工查阅、图片、扩展解释。
4. 英文 StackExchange 用于补充中文 Guide/Wiki 不足的领域背景。
5. 英文内容不作为中文决策主来源。
6. Retrieval v2 只能访问 nopic 决策通道。
7. 查询页面可以访问 maxi / 英文补充通道。
8. mini 仅用于测试或降级。
