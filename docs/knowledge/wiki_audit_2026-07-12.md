...
## 覆盖范围
- Markdown wiki 条目：693
- PocketBase wiki_articles：693
- PocketBase wiki_categories：24
- data/lanternbox.db 表：inventory, journal, sqlite_sequence
...
## 文件与数据库一致性
- 通过：693 个 Markdown slug 与 PocketBase wiki_articles 一一对应，标题、分类、摘要、标签、风险等级、状态、来源和正文均一致。
